...
func Load() (*Config, error) {
	c := &Config{
		...
		S3Bucket:            getEnv("S3_BUCKET", "devsper-registry-packages"),
		S3Region:            getEnv("S3_REGION", "us-east-1"),
		S3CloudFrontDomain:  getEnv("S3_CLOUDFRONT_DOMAIN", "packages.devsper.com"),
		...
		SESFromAddress:      getEnv("SES_FROM_ADDRESS", "noreply@devsper.com"),
		SESReplyTo:          getEnv("SES_REPLY_TO", "support@devsper.com"),
